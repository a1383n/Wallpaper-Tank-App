...
public class WallpaperSetActivity extends AppCompatActivity {
        ...
        Glide.with(this).load(wallpaper.getWallpaper())
                ...
                .addListener(new RequestListener<Drawable>() {
                    ...
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        // Set ErrorDialog
                        ThemeManager.getNetworkErrorDialog(WallpaperSetActivity.this, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                finish();
                                startActivity(new Intent(WallpaperSetActivity.this,WallpaperSetActivity.class)
                                        .putExtra("json",getIntent().getStringExtra("json")));
                            }
                        });
                        return false;
                    }
    ...
    private void Initialization() {
        ...
        //Get json input from Intent and convert to Wallpaper
        ...
        //When click on BottomSheetBehavior expanded
        ...
        //Set default state for BottomSheetBehavior
        sheetBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);
...
>>>>>>> Stashed changes
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.set_wallpaper:
                //Create and show save method dialog
    ...
    /**
     * set Wallpaper in phone background
     * @param flag
     */
...
=======
        ...
        // Check we can set wallpaper automatic or not
>>>>>>> Stashed changes
    ...
    /**
     * Device not support set wallpaper automatic ErrorDialog
     * @return
     */
